...
template <class T>
string inttobin_BE(T i, unsigned int size = 0);
template <class T>
string inttobin_LE(T i, unsigned int size = 0);
template <class T>
string inttohex_BE(T i, unsigned int size = 0);
template <class T>
string inttohex_LE(T i, unsigned int size = 0);
...
//----------------------------------------------------------------------------------------------------------------------
{
    int isletter = (x & 0x40) >> 6;
    return (isletter | (isletter << 3)) + (x & 0x0F);
}
...
//----------------------------------------------------------------------------------------------------------------------
template <>
inline unsigned hammingweight(string s)
//----------------------------------------------------------------------------------------------------------------------
{
    unsigned hw = 0;
