...
int main()
{
  ...
  printf("Hash of \"%s\":\n\t%08lX%08lX %08lX%08lX %08lX%08lX\n", \
    ...
    printf("Hash of a 64K-byte string:\n\t%08lX%08lX %08lX%08lX %08lX%08lX\n", (word32)(res[0] >> 32), (word32)(res[0]),
           (word32)(res[1] >> 32), (word32)(res[1]), (word32)(res[2] >> 32), (word32)(res[2]));
    ...
    rate = (double)CLOCKS_PER_SEC * (double)ITERATIONS * 65556.0 * 8.0 / ((double)(t2 - t1));
